...
namespace Erlang.NET
{
     ...
     */
    [Serializable]
    public class OtpErlangList : OtpErlangObject, IEnumerable
    {
        // don't change this!
        ...
        protected virtual IEnumerator iterator(int start)
        {
        ...
        private class SubList : OtpErlangList
        {
            ...
            protected override IEnumerator iterator(int start)
            {
                return parent.iterator(start);
            }
        }

        private class Itr : IEnumerator
        {
            /**
